...
def CFNOTTMTotalDebt(beg_date, end_date):
    ...
    total_liability = Stock().get_factor_h5("TotalLiability", None, "primary_mfc")
    ...
    cfo_td = StockFactorOperate().change_quarter_to_daily_with_report_date(cfo_td, beg_date, end_date)
...
if __name__ == '__main__':
    ...
    data = CFNOTTMTotalDebt(beg_date, end_date)
    print(data)
