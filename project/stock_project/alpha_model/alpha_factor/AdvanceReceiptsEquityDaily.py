...
def AdvanceReceiptsEquityDaily(beg_date, end_date):
    ...
    equity = StockFactorOperate().change_quarter_to_daily_with_disclosure_date(equity, report_data, beg_date, end_date)
...
if __name__ == '__main__':
    ...
    data = AdvanceReceiptsEquityDaily(beg_date, end_date)
    print(data)
