...
def GrossProfitTTMMarketValueDaily(beg_date, end_date):
    ...
    gross_profit = StockFactorOperate().change_quarter_to_daily_with_disclosure_date(gross_profit, report_data, beg_date, end_date)
...
if __name__ == '__main__':
    ...
    data = GrossProfitTTMMarketValueDaily(beg_date, end_date)
    print(data)
