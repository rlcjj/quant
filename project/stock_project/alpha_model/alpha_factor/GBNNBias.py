...
def GBNNBias(beg_date, end_date):

    """
    因子说明： 最近10天平均 减去 之前30天平均 股吧点击数量 的负值
    """
    ...
    factor_name = "GBNNBias"
    ipo_num = 90

    # read data
    #################################################################################
    click_num = Stock().get_factor_h5("GBNN", None, "primary_mfc")
...
if __name__ == '__main__':
    ...
    data = GBNNBias(beg_date, end_date)
    print(data)
