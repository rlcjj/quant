...
def AdvanceReceiptsEquity(beg_date, end_date):
    ...
    equity = Stock().get_factor_h5("TotalShareHoldeRequity", None, "primary_mfc")

    advance = StockFactorOperate().change_quarter_to_daily_with_report_date(advance, beg_date, end_date)
    equity = StockFactorOperate().change_quarter_to_daily_with_report_date(equity, beg_date, end_date)
...
if __name__ == '__main__':
    ...
    data = AdvanceReceiptsEquity(beg_date, end_date)
    print(data)
